...
class MemeCollectionViewController: UICollectionViewController {
    ...
    func openMemeEditor() {
        ...
        let memeEditor = storyboard.instantiateViewControllerWithIdentifier("MemeEditor") as! MemeEditor
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.contentView.translatesAutoresizingMaskIntoConstraints = false // gets rid of autoconstraint breakage warning, but now we need to set the image size explicitly so it doesn't extend past the cell frame
...
extension MemeCollectionViewController : UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(collectionView: UICollectionView,
        ...
        sizeForItemAtIndexPath indexPath: NSIndexPath) -> CGSize {
            ...
            let maxWidth = (view.bounds.size.width / numColumns) - 24.0
